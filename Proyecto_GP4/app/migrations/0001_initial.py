    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('En preparación', 'En preparación'), ('Listo', 'Listo'), ('Entregado', 'Entregado')], default='En preparación', max_length=15)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('verificar_contrasena', models.CharField(max_length=128)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('En preparación', 'En preparación'), ('Entregado', 'Entregado')], default='En preparación', max_length=15)),
                ('comanda', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.comanda')),
